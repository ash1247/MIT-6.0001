...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for p in perm_list:
            transpose_dct_list.append(self.build_transpose_dict(p))
        for i in transpose_dct_list:
            message = self.apply_transpose(i)
        ...
        possible_message = []
        for t in big_test:
            if t[0] == best_choice[0] and t[1] not in possible_message:
                possible_message.append(t[1])
        string = ""
